 ...
 * <p/>
 * Some constructors take columnFields and updateByFields. These values will be
 * used during field name resolution to bind this Scheme to the source and sink
 * branches in a give assembly. These fields 'alias' the column names in the
 * respective arrays. In other words, if your DB TABLE has different column
 * names than your assembly expects, use the Fields arguments to bind the
 * assembly to the table. Both Fields and array must be the same size.
 * <p/>
 * Override this class, {@link DBInputFormat}, and {@link DBOutputFormat} to
 * specialize for a given vendor database.
 */
public class JDBCScheme extends
    Scheme<JobConf, RecordReader, OutputCollector, Object[], Object[]>
  {
    ...
    public JDBCScheme(Class<? extends DBInputFormat> inputFormatClass,
      ...
      {
        this(inputFormatClass, outputFormatClass, new Fields(columns), columns,
            orderBy, conditions, limit, updateBy != null ? new Fields(updateBy)
                : null, updateBy);
      }
    ...
    public JDBCScheme(Class<? extends DBInputFormat> inputFormatClass,
        ...
        String[] columns, String[] orderBy, String conditions, long limit,
        ...
        if (updateBy != null && updateBy.length != 0)
          {
            ...
            if (updateByFields.size() != updateBy.length)
              throw new IllegalArgumentException(
                  "updateByFields and updateBy must be the same size");

            if (!this.columnFields.contains(this.updateByFields))
              throw new IllegalArgumentException(
                  "columnFields must contain updateByFields column names");

            this.updateValueFields = columnFields.subtract(updateByFields)
                .append(updateByFields);
    ...
    public JDBCScheme(Class<? extends DBInputFormat> inputFormatClass,
      ...
      {
        this(inputFormatClass, outputFormatClass, columnFields, columns,
            orderBy, conditions, limit, updateByFields, updateBy, true);
    ...
    private void verifyColumns(Fields columnFields, String[] columns)
      {
        if (columnFields.size() != columns.length)
          throw new IllegalArgumentException(
              "columnFields and columns must be the same size");
      }
    ...
    public JDBCScheme(Class<? extends DBInputFormat> inputFormatClass,
      ...
      {
        this(inputFormatClass, outputFormatClass, columns, orderBy, conditions,
            -1, updateBy);
      }
    ...
    public JDBCScheme(Class<? extends DBInputFormat> inputFormatClass,
        Class<? extends DBOutputFormat> outputFormatClass, Fields columnFields,
        String[] columns, String[] orderBy, String conditions,
        Fields updateByFields, String[] updateBy)
      {
        this(inputFormatClass, outputFormatClass, columnFields, columns,
            orderBy, conditions, -1, updateByFields, updateBy);
      }
    ...
    public JDBCScheme(Class<? extends DBInputFormat> inputFormatClass,
      ...
      {
        this(inputFormatClass, outputFormatClass, columns, orderBy, null,
            updateBy);
      }
    ...
    public JDBCScheme(Class<? extends DBInputFormat> inputFormatClass,
        Class<? extends DBOutputFormat> outputFormatClass, Fields columnFields,
        String[] columns, String[] orderBy, Fields updateByFields,
        String[] updateBy)
      {
        this(inputFormatClass, outputFormatClass, columnFields, columns,
            orderBy, null, -1, updateByFields, updateBy);
      }
    ...
    public JDBCScheme(Fields columnFields, String[] columns, String[] orderBy,
        Fields updateByFields, String[] updateBy)
      {
        this(null, null, columnFields, columns, orderBy, updateByFields,
            updateBy);
      }
    ...
    public JDBCScheme(Fields columnFields, String[] columns, String[] orderBy,
      ...
      {
        this(null, null, columnFields, columns, orderBy, conditions, limit,
            null, null);
      }
    ...
    public JDBCScheme(Fields columnFields, String[] columns, String[] orderBy,
        long limit)
      {
        this(null, null, columnFields, columns, orderBy, null, limit, null,
            null);
      }
    ...
    public JDBCScheme(String[] columns, String conditions, long limit)
      {
        this(null, null, new Fields(columns), columns, null, conditions, limit,
            null, null);
      }
    ...
    public JDBCScheme(Fields columnFields, String[] columns, String conditions,
        long limit)
      {
        this(null, null, columnFields, columns, null, conditions, limit, null,
            null);
      }
    ...
    public JDBCScheme(String[] columns, long limit)
      {
        this(null, null, new Fields(columns), columns, null, null, limit, null,
            null);
      }
    ...
    public JDBCScheme(Class<? extends DBInputFormat> inputFormatClass,
      ...
      {
        this(inputFormatClass, new Fields(columns), columns, selectQuery,
            countQuery, limit, true);
      }
    ...
    public JDBCScheme(Class<? extends DBInputFormat> inputFormatClass,
      ...
      {
        this(inputFormatClass, columnFields, columns, selectQuery, countQuery,
            limit, true);
      }
    ...
    public void sourceConfInit(FlowProcess<JobConf> process,
        Tap<JobConf, RecordReader, OutputCollector> tap, JobConf conf)
      {
        ...
        if (selectQuery != null)
          DBInputFormat.setInput(conf, TupleRecord.class, selectQuery,
              countQuery, limit, concurrentReads, tableAlias);
        else
          {
            String tableName = ((JDBCTap) tap).getTableName();
            String joinedOrderBy = orderBy != null ? Util.join(orderBy, ", ")
                : null;
            DBInputFormat.setInput(conf, TupleRecord.class, tableName,
                conditions, joinedOrderBy, limit, concurrentReads, tableAlias,
                columns);
          }
    ...
    public void sinkConfInit(FlowProcess<JobConf> process,
        Tap<JobConf, RecordReader, OutputCollector> tap, JobConf conf)
      {
        ...
        DBOutputFormat.setOutput(conf, DBOutputFormat.class, tableName,
            columns, updateBy, batchSize);
    ...
    public boolean equals(Object object)
      {
        ...
        if (limit != that.limit)
          return false;
        if (columnFields != null ? !columnFields.equals(that.columnFields)
            : that.columnFields != null)
          return false;
        if (!Arrays.equals(columns, that.columns))
          return false;
        if (conditions != null ? !conditions.equals(that.conditions)
            : that.conditions != null)
          return false;
        if (countQuery != null ? !countQuery.equals(that.countQuery)
            : that.countQuery != null)
          return false;
        if (inputFormatClass != null ? !inputFormatClass
            .equals(that.inputFormatClass) : that.inputFormatClass != null)
          return false;
        if (!Arrays.equals(orderBy, that.orderBy))
          return false;
        if (outputFormatClass != null ? !outputFormatClass
            .equals(that.outputFormatClass) : that.outputFormatClass != null)
          return false;
        if (selectQuery != null ? !selectQuery.equals(that.selectQuery)
            : that.selectQuery != null)
          return false;
        if (!Arrays.equals(updateBy, that.updateBy))
          return false;
        if (updateByFields != null ? !updateByFields
            .equals(that.updateByFields) : that.updateByFields != null)
          return false;
        if (updateIfTuple != null ? !updateIfTuple.equals(that.updateIfTuple)
            : that.updateIfTuple != null)
          return false;
        if (updateValueFields != null ? !updateValueFields
            .equals(that.updateValueFields) : that.updateValueFields != null)
          return false;
    ...
    public int hashCode()
      {
        ...
        result = 31 * result
            + (inputFormatClass != null ? inputFormatClass.hashCode() : 0);
        result = 31 * result
            + (outputFormatClass != null ? outputFormatClass.hashCode() : 0);
        result = 31 * result + (columns != null ? Arrays.hashCode(columns) : 0);
        result = 31 * result + (orderBy != null ? Arrays.hashCode(orderBy) : 0);
        result = 31 * result + (conditions != null ? conditions.hashCode() : 0);
        result = 31 * result
            + (updateBy != null ? Arrays.hashCode(updateBy) : 0);
        result = 31 * result
            + (updateValueFields != null ? updateValueFields.hashCode() : 0);
        result = 31 * result
            + (updateByFields != null ? updateByFields.hashCode() : 0);
        result = 31 * result
            + (columnFields != null ? columnFields.hashCode() : 0);
        result = 31 * result
            + (updateIfTuple != null ? updateIfTuple.hashCode() : 0);
        result = 31 * result
            + (selectQuery != null ? selectQuery.hashCode() : 0);
